...
`unravel.utils.``dummy_labels`(_`dataset`_)[`[source]`](https://unravelsports.readthedocs.io/en/latest/_modules/unravel/utils/utils.html#dummy_labels) `unravel.utils.dummy_labels`
...
`unravel.utils.``add_dummy_label_column`(_`dataset`_, _`by``=``['gameId',` `'playId',` `'frameId']`_, _`column_name``=``'label'`_, _`random_seed``=``None`_)[`[source]`](https://unravelsports.readthedocs.io/en/latest/_modules/unravel/utils/utils.html#add_dummy_label_column) `unravel.utils.add_dummy_label_column`
...
`unravel.utils.``dummy_graph_ids`(_`dataset`_)[`[source]`](https://unravelsports.readthedocs.io/en/latest/_modules/unravel/utils/utils.html#dummy_graph_ids) `unravel.utils.dummy_graph_ids`
...
`unravel.utils.``add_graph_id_column`(_`dataset`_, _`by``=``['game_id',` `'play_id']`_, _`column_name``=``'graph_id'`_)[`[source]`](https://unravelsports.readthedocs.io/en/latest/_modules/unravel/utils/utils.html#add_graph_id_column) `unravel.utils.add_graph_id_column`
