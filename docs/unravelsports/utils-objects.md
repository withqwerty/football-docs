...
_`class`_ `unravel.utils.``GraphDataset`[`[source]`](https://unravelsports.readthedocs.io/en/latest/_modules/unravel/utils/objects/graph_dataset.html#GraphDataset) `unravel.utils.GraphDataset`
