---
source_url: https://unravelsports.readthedocs.io/en/latest/additional/license.html
source_type: crawled
...
The complete license text can be found in the [LICENSE file](https://github.com/unravelsports/unravelsports/blob/main/LICENSE) in the repository.

For a human-readable summary, see the [tl;dr Legal page for MPL 2.0](https://www.tldrlegal.com/license/mozilla-public-license-2-0-mpl-2).
...
For questions about licensing, please open an issue on [GitHub](https://github.com/unravelsports/unravelsports/issues).