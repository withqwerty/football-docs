---
source_url: https://unravelsports.readthedocs.io/en/latest/getting_started/concepts.html
source_type: crawled
...
See the [Soccer Graph Neural Networks](https://unravelsports.readthedocs.io/en/latest/tutorials/soccer_gnn.html) tutorial and [Graph FAQ](https://github.com/unravelsports/unravelsports/blob/main/examples/graphs_faq.md) for more details.
...
See [Bekkers (2024)](https://arxiv.org/pdf/2501.04712) for the mathematical formulation.
...
See [Bekkers (2025)](https://arxiv.org/pdf/2506.23843) for details.