---
source_url: https://unravelsports.readthedocs.io/en/latest/getting_started/quickstart.html
source_type: crawled
...
-   Read the [Core Concepts](https://unravelsports.readthedocs.io/en/latest/getting_started/concepts.html) guide to understand the core concepts
    
-   Check out the [Soccer Graph Neural Networks](https://unravelsports.readthedocs.io/en/latest/tutorials/soccer_gnn.html) tutorial for an in-depth walkthrough
    
-   Explore the [Soccer](https://unravelsports.readthedocs.io/en/latest/api/soccer.html) API reference
    
-   View the [example Jupyter notebooks](https://github.com/unravelsports/unravelsports/tree/main/examples)