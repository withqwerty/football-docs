---
source_url: https://developer.sportradar.com/soccer/reference/soccer-extended-player-schedules
...
**Soccer Extended Player Schedules** provides schedules and results of the last 10 matches played for a given player.
