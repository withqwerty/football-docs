---
source_url: https://developer.sportradar.com/soccer/reference/soccer-extended-daily-summaries
...
**Soccer Extended Daily Summaries** provides match information for a given day including team scoring, player and team match statistics.
...
>
> Learn how to use Daily Summaries to pull a day's fixtures with results in our [Fixtures (Schedules)](https://developer.sportradar.com/soccer/docs/soccer-ig-fixtures) integration scenario.
