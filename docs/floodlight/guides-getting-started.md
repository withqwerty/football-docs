...
Now that we have some objects loaded, let’s manipulate them. Below are just a few examples, for all methods check out the respective class methods in the [core](https://floodlight.readthedocs.io/en/latest/modules/core/core.html) module reference.
