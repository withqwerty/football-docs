...
`floodlight.io.kinexon.``create_links_from_meta_data`(_`pID_dict`_, _`identifier``=``None`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/io/kinexon.html#create_links_from_meta_data) `floodlight.io.kinexon.create_links_from_meta_data`
...
`floodlight.io.kinexon.``get_column_names_from_csv`(_`filepath_data`_, _`delimiter``=``','`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/io/kinexon.html#get_column_names_from_csv) `floodlight.io.kinexon.get_column_names_from_csv`
...
`floodlight.io.kinexon.``get_meta_data`(_`filepath_data`_, _`delimiter``=``','`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/io/kinexon.html#get_meta_data) `floodlight.io.kinexon.get_meta_data`
...
`floodlight.io.kinexon.``read_position_data_csv`(_`filepath_data`_, _`delimiter``=``','`_, _`teamsheets``=``None`_, _`as_dict``=``False`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/io/kinexon.html#read_position_data_csv) `floodlight.io.kinexon.read_position_data_csv`
...
`floodlight.io.kinexon.``read_teamsheets_from_csv`(_`filepath_data`_, _`delimiter``=``','`_, _`as_dict``=``False`_, _`player_id``=``None`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/io/kinexon.html#read_teamsheets_from_csv) `floodlight.io.kinexon.read_teamsheets_from_csv`
