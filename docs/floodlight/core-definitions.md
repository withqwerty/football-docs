---
source_url: https://floodlight.readthedocs.io/en/latest/modules/core/definitions.html
source_type: crawled
upstream_version:
...
The following source code defines essential and protected columns for usage in [Events](https://floodlight.readthedocs.io/en/latest/modules/core/events.html) and [Teamsheet](https://floodlight.readthedocs.io/en/latest/modules/core/teamsheet.html) objects.
