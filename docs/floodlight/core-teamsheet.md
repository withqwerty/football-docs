...
---
_`class`_ `floodlight.core.teamsheet.``Teamsheet`(_`teamsheet`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/core/teamsheet.html#Teamsheet)
...
`add_xIDs`()[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/core/teamsheet.html#Teamsheet.add_xIDs)
...
`column_values_in_range`(_`col`_, _`definitions`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/core/teamsheet.html#Teamsheet.column_values_in_range)
...
`get_links`(_`keys`_, _`values`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/core/teamsheet.html#Teamsheet.get_links)
