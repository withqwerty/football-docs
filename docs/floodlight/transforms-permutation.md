...
`floodlight.transforms.permutation.``assign_roles`(_`xy`_, _`reference``=``None`_, _`n_iter``=``1`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/transforms/permutation.html#assign_roles) `floodlight.transforms.permutation.assign_roles`
