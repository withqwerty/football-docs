...
---
_`class`_ `floodlight.core.property.``DyadicProperty`(_`property`_, _`name`_, _`framerate``=``None`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/core/property.html#DyadicProperty) `floodlight.core.property.DyadicProperty`
...
`slice`(_`startframe``=``None`_, _`endframe``=``None`_, _`inplace``=``False`_) `floodlight.core.property.DyadicProperty.slice`
...
_`class`_ `floodlight.core.property.``PlayerProperty`(_`property`_, _`name`_, _`framerate``=``None`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/core/property.html#PlayerProperty) `floodlight.core.property.PlayerProperty`
...
`slice`(_`startframe``=``None`_, _`endframe``=``None`_, _`inplace``=``False`_) `floodlight.core.property.PlayerProperty.slice`
...
_`class`_ `floodlight.core.property.``TeamProperty`(_`property`_, _`name`_, _`framerate``=``None`_)[`[source]`](https://floodlight.readthedocs.io/en/latest/_modules/floodlight/core/property.html#TeamProperty) `floodlight.core.property.TeamProperty`
...
`slice`(_`startframe``=``None`_, _`endframe``=``None`_, _`inplace``=``False`_) `floodlight.core.property.TeamProperty.slice`
