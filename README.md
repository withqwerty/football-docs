...
| kloppy | 122 | data-model, usage, provider-mapping, tracking-rendering, event-derived-metrics |
...
| Opta | 72 | event-types, qualifiers, coordinate-system, api-access, charting-game-state, charting-lineups, charting-passmaps, charting-set-pieces, charting-shot-placement, identity-surfaces |
...
**1,195 searchable chunks** across 19 providers and tools.
