...
| Opta | 69 | event-types, qualifiers, coordinate-system, api-access, charting-game-state, charting-lineups, charting-passmaps, charting-set-pieces, charting-shot-placement, identity-surfaces |
...
**1,181 searchable chunks** across 19 providers and tools.
