...
| mplsoccer | 60 | overview, pitch-types, visualizations |
...
| Opta | 68 | event-types, qualifiers, coordinate-system, api-access, charting-game-state, charting-lineups, charting-passmaps, charting-set-pieces, charting-shot-placement, identity-surfaces |
...
**1,179 searchable chunks** across 19 providers and tools.
